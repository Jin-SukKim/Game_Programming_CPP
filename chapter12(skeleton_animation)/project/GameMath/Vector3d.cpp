...
const Vector3d Vector3d::Black(0.0f, 0.0f, 0.0f);
const Vector3d Vector3d::White(1.0f, 1.0f, 1.0f);
const Vector3d Vector3d::Red(1.0f, 0.0f, 0.0f);
const Vector3d Vector3d::Green(0.0f, 1.0f, 0.0f);
const Vector3d Vector3d::Blue(0.0f, 0.0f, 1.0f);
const Vector3d Vector3d::Yellow(1.0f, 1.0f, 0.0f);
const Vector3d Vector3d::LightYellow(1.0f, 1.0f, 0.88f);
const Vector3d Vector3d::LightBlue(0.68f, 0.85f, 0.9f);
const Vector3d Vector3d::LightPink(1.0f, 0.71f, 0.76f);
const Vector3d Vector3d::LightGreen(0.56f, 0.93f, 0.56f);
